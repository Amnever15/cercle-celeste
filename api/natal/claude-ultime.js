...
async function generateUltimeBody(contact, hd, astro, geneKeys, onProgress) {
  ...
  if (onProgress) onProgress('Ultime — fondations cosmiques (I–VII)…', 40);
  ...
  if (onProgress) onProgress('Ultime — architecture HD & maisons (VIII–XIV)…', 52);
  ...
  if (onProgress) onProgress('Ultime — mission & vocation (XV–XXIII)…', 62);
  ...
  if (onProgress) onProgress('Ultime — affirmations, rituels, synthèse…', 68);
