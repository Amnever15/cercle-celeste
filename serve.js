...
const PORT = 8788;
const API_PORT = 8789;
const API_ROUTES = ['/health', '/access', '/login', '/admin', '/admin/grant', '/admin/natal-reset', '/admin/couple-reset', '/systeme-webhook', '/webhook-debug', '/generate', '/ia', '/ia-live/session', '/ia-live/turn', '/ia-live/excerpt', '/ia-live/end', '/tts', '/manuscript-tts', '/manuscript-tts-audio', '/profile', '/profile-partner', '/natal-file', '/mois-file', '/jour-file', '/couple-file', '/ultime-file', '/download-all'];
const types = {
